 ...
 */
export async function encrypt(params, key, data) {
 ...
 */
export async function decrypt(params, key, data) {
    const derived = await deriveKeyNonce(key, params.iv);
 ...
 */
export async function generateKey(extractable = false) {
